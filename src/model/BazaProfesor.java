...
public class BazaProfesor {
	...
	private void initProfesor() {
		...
		profesori.add(new Profesor("Petar", "Petrovic", LocalDate.of(1999, 5, 25), "+38169877633", "Tolstojeva 10",
				"petarpetrovic@gmail.com", "Radnicka 17", "199928277745", "Prof. dr", "Redovni profesor", null));
		incBroj_Profesora(); // povecavamo broj profesora
		profesori.add(new Profesor("Nikola", "Nikolic", LocalDate.of(1980, 4, 17), "+38169667633", "Tolstojeva 1",
				"nikolanikolic@gmail.com", "Radnicka 17", "1980777166111", "MSc", "Saradnik u nastavi", null));
		incBroj_Profesora();
	...
	public void dodajProfesora(String ime, String prezime, LocalDate datumRodjena, String brojTelefona,
		...
		this.profesori.add(new Profesor(ime, prezime, datumRodjena, brojTelefona, adresaStanovanja, email,
				adresaKancelarije, brLicneKarte, titula, zvanjeProfesora, null));
		incBroj_Profesora();
	}
	...
	String email, String adresaKancelarije,
	String brLicneKarte, String titula,
	String zvanjeProfesora)
	{
