...
public class StatusBar extends JPanel implements Runnable{
	...
	StatusBar()
	{
		...
		JLabel nazivApp = new JLabel("		Studentska sluzba");
	...
	/* https://docs.oracle.com/javase/7/docs/api/java/text/SimpleDateFormat.html klasa SimpleDate format omogucava da formatiramo datum u zeljeni oblik na jednostavan nacin*/
	/*https://docs.oracle.com/javase/7/docs/api/java/text/SimpleDateFormat.html klasa Calendar je apstraktna klasa, pozivanjem metode getInstance() ove klase dobijamo trenutno vreme*/
	@Override
	public void run() {
